! function(e, t) {
    ...
    var u = l(function(e, t) {
            (function() {
                ...
                function v(e) {
                    return null == e ? p(e) : u.call(e).slice(8, -1)
                }
                ...
                var S = function e(t) {
                    ...
                    var o = r.navigator || {},
                        a = o.userAgent || "";
                    t || (t = a);
                    var c, d, l, p, S, C = i ? !!o.likeChrome : /\bChrome\b/.test(t) && !/internal|\n/i.test(u.toString()),
    ...
    class m {
        constructor(e, t, n) {
            this.context = e, this.isStart = !1, this.postfix = n, this.audioFile, this.stream = new MediaStream(t.getAudioTracks()), this.type = "Firefox" === u.name ? "audio/ogg" : "audio/webm", this.recorder = new MediaRecorder(this.stream, {
    ...
    class g {
        ...
        bindLocalStreamToPeerConnection(e) {
            0 != this.context.useVideo || 0 != this.context.useAudio ? (this.context.hasAddTrack ? (this.context.simulcast && parseInt(u.version.split(".")[0], 10) >= 74 && "Chrome" === u.name ? (this.context.config.rtc.localStream.getAudioTracks().forEach(t => e.addTransceiver(t, {
        ...
        async captureScreen(e, t, n, r) {
            ...
            this.context.videoTransceiver.sender.replaceTrack(i), this.context.screenStream.getAudioTracks().length > 0 && this.context.audioTransceiver.sender.replaceTrack(this.mergeAudioStreams(this.context.screenStream, this.context.config.rtc.localStream)), this.context.config.rtc.localVideo.srcObject = this.context.screenStream
        }
        stopCaptureScreen() {
            try {
                this.showLocalVideo()
    ...
    class y {
        ...
        async check() {
            ...
            n.forEach(e => {
                r[e.id] = e
            }), "Safari" === u.name || "safari" === u.name ? Object.keys(r).forEach(n => {
            ...
            }) : "Firefox" === u.name ? Object.keys(r).forEach(n => {
            ...
            }) : "Chrome" === u.name && Object.keys(r).forEach(n => {
                "inbound-rtp" === r[n].type ? "audio" === r[n].kind ? (this.result.audioPacketsReceived = r[n].packetsReceived, this.result.audioPacketsLoss = r[n].packetsLost) : (this.result.videoPacketsReceived = r[n].packetsReceived, this.result.videoPacketsLoss = r[n].packetsLost) : "outbound-rtp" === r[n].type ? "audio" === r[n].kind ? this.result.audioPacketsSent = r[n].packetsSent : this.result.videoPacketsSent = r[n].packetsSent : "candidate-pair" === r[n].type && "succeeded" === r[n].state && (t = r[n].localCandidateId, e = r[n].remoteCandidateId, t && e && (this.result.localCandidate = r[t].candidateType, this.result.protocol = r[t].protocol, this.result.remoteCandidate = r[e].candidateType))
    ...
    class C {
        ...
        async getStats() {
            if ("Safari" === u.name || "safari" === u.name);
            else if ("Firefox" === u.name) {
            ...
            } else if ("Chrome" === u.name || "Chrome Mobile" === u.name) {
                let t, n, r, i = await this.context.peerConnection.getStats(null),
                    o = {},
                    a = "RTCTransport_0_1";
                this.oldResult = {
    ...
    function N({
        ...
        const r = {
            async onCreate(t) {
                ...
                e.eventManager.hasEventListener("onStateChange") && e.eventManager.dispatchEvent("onStateChange", "WAIT"), t.channel || e.eventManager.hasEventListener("onError") && e.eventManager.dispatchEvent("onError", "ConnectChannelFailedError"), e.channel = t.channel, f.i("Channel id:", e.channel.id), f.i("Channel type: ", e.channel.type), !0 !== n.media.recvonly && (f.d("try to create local stream"), await e.mediaManager.createLocalStream(e, n.media), e.mediaManager.bindLocalStreamToPeerConnection(e.peerConnection), f.i("success to create and bind local stream to pc")), e.eventManager.hasEventListener("onCreateChannel") && e.eventManager.dispatchEvent("onCreateChannel", e.channel.id), e.eventManager.hasEventListener("onConnect") && "P2P" === e.channel.type && e.eventManager.dispatchEvent("onConnect", e.channel.id), !e.eventManager.hasEventListener("onCreate") || "BROADCAST" !== e.channel.type && "ROOM" !== e.channel.type ? e.eventManager.hasEventListener("onJoin") && "VIEWER" === e.channel.type && e.eventManager.dispatchEvent("onJoin", e.channel.id) : e.eventManager.dispatchEvent("onCreate", e.channel.id), "BROADCAST" === e.channel.type || "ROOM" === e.channel.type ? function() {
                    ...
                    if ("BROADCAST" === e.channel.type && "Firefox" === u.name && e.simulcast) {
                        const t = 1;
                    ...
                    f.i("createViewerOffer is called " + u.name);
            ...
            onSdp(t) {
                ...
                f.evt(JSON.stringify(i)), f.d("-> Remote Description:", r), e.videoBandwidth && "Safari" !== u.name && "safari" !== u.name && (r.sdp = v.setMediaBitrate(r.sdp, "video", e.videoBandwidth)), "music" === n.rtc.audioType && "Safari" !== u.name && "safari" !== u.name && (r.sdp = r.sdp.replace("a=rtpmap:111 opus/48000/2", "a=rtpmap:111 opus/48000/2\na=fmtp:111 maxaveragebitrate=128000;stereo=1;cbr=1")), e.peerConnection.setRemoteDescription(r).then(() => {
                        ...
                        case "COMPLETE":
                            ...
                            var n = {
                                ...
                                messages: {
                                    ...
                                    logLevel: "info",
                                    os: u.os.family,
                                    osVersion: u.os.version || "0",
                                    device: u.name,
                                    deviceVersion: u.version || "0",
        ...
        function o(t) {
            f.i("new Local Description:", t), e.videoCodec ? (f.v("Signaling: video codec: " + e.videoCodec), t.sdp = c(t.sdp, /m=video(:?.*)?/, e.videoCodec)) : (f.v("Signaling: video codec: H264"), t.sdp = c(t.sdp, /m=video(:?.*)?/, "H264")), e.videoBandwidth && (t.sdp = v.setMediaBitrate(t.sdp, "video", e.videoBandwidth)), "BROADCAST" === e.channel.type && "Chrome" === u.name && parseInt(u.version.split(".")[0], 10) < 74 && e.simulcast && (t.sdp = function(e) {
    ...
    var pe = function(e, t) {
        ...
        Object.defineProperty(i.prototype, "localDescription", {
            ...
            if (this._isClosed) throw ue("InvalidStateError", "Attempted to call addTrack on a closed peerconnection.");
            var r;
            if (this.transceivers.find(function(e) {
                    return e.track === t
                })) throw ue("InvalidAccessError", "Track already exists.");
            ...
            if (this._isClosed) throw ue("InvalidStateError", "Attempted to call removeTrack on a closed peerconnection.");
            ...
            if (!n) throw ue("InvalidAccessError", "Sender was not created by this connection.");
            var r = n.stream;
            ...
            var t, n, r = this;
            if (-1 === ["offer", "answer"].indexOf(e.type)) return Promise.reject(ue("TypeError", 'Unsupported type "' + e.type + '"'));
            if (!de("setLocalDescription", e.type, r.signalingState) || r._isClosed) return Promise.reject(ue("InvalidStateError", "Can not set local " + e.type + " in state " + r.signalingState));
            if ("offer" === e.type) t = ae.splitSections(e.sdp), n = t.shift(), t.forEach(function(e, t) {
                ...
                t.forEach(function(e, t) {
                    ...
                    if (!(ae.isRejected(e) && 0 === ae.matchPrefix(e, "a=bundle-only").length) && !o.rejected) {
                        var u = ae.getIceParameters(e, n),
                            p = ae.getDtlsParameters(e, n);
                        i && (p.role = "server"), r.usingBundle && 0 !== t || (r._gather(o.mid, t), "new" === s.state && s.start(a, u, i ? "controlling" : "controlled"), "new" === c.state && c.start(p));
                        var h = ce(d, l);
            ...
            var o = this;
            if (-1 === ["offer", "answer"].indexOf(i.type)) return Promise.reject(ue("TypeError", 'Unsupported type "' + i.type + '"'));
            if (!de("setRemoteDescription", i.type, o.signalingState) || o._isClosed) return Promise.reject(ue("InvalidStateError", "Can not set remote " + i.type + " in state " + o.signalingState));
            var a = {};
            ...
            var s = [],
                ...
                u = ae.matchPrefix(d, "a=group:BUNDLE ").length > 0;
            o.usingBundle = u;
            var p = ae.matchPrefix(d, "a=ice-options:")[0];
            return o.canTrickleIceCandidates = !!p && p.substr(14).split(" ").indexOf("trickle") >= 0, c.forEach(function(r, c) {
                var p = ae.splitLines(r),
                    h = ae.getKind(r),
                ...
                if (f || "application" === h && ("DTLS/SCTP" === v || "UDP/DTLS/SCTP" === v)) o.transceivers[c] = {
                    ...
                    if (("offer" === i.type || "answer" === i.type) && !f && u && c > 0 && o.transceivers[c] && (o._disposeIceAndDtlsTransports(c), o.transceivers[c].iceGatherer = o.transceivers[0].iceGatherer, o.transceivers[c].iceTransport = o.transceivers[0].iceTransport, o.transceivers[c].dtlsTransport = o.transceivers[0].dtlsTransport, o.transceivers[c].rtpSender && o.transceivers[c].rtpSender.setTransport(o.transceivers[0].dtlsTransport), o.transceivers[c].rtpReceiver && o.transceivers[c].rtpReceiver.setTransport(o.transceivers[0].dtlsTransport)), "offer" !== i.type || f) {
                        if ("answer" === i.type && !f) {
                            C = (S = o.transceivers[c]).iceGatherer, E = S.iceTransport, b = S.dtlsTransport, _ = S.rtpReceiver, R = S.sendEncodingParameters, x = S.localCapabilities, o.transceivers[c].recvEncodingParameters = T, o.transceivers[c].remoteCapabilities = O, o.transceivers[c].rtcpParameters = L, I.length && "new" === E.state && (!l && !M || u && 0 !== c ? I.forEach(function(e) {
                                le(S.iceTransport, e)
                            }) : E.setRemoteCandidates(I)), u && 0 !== c || ("new" === E.state && E.start(C, w, "controlling"), "new" === b.state && b.start(P)), !ce(S.localCapabilities, S.remoteCapabilities).codecs.filter(function(e) {
                        ...
                        (S = o.transceivers[c] || o._createTransceiver(h)).mid = y, S.iceGatherer || (S.iceGatherer = o._createIceGatherer(c, u)), I.length && "new" === S.iceTransport.state && (!M || u && 0 !== c ? I.forEach(function(e) {
                            le(S.iceTransport, e)
            ...
            var n = this;
            if (n._isClosed) return Promise.reject(ue("InvalidStateError", "Can not call createOffer after close"));
            ...
            var n = this;
            if (n._isClosed) return Promise.reject(ue("InvalidStateError", "Can not call createAnswer after close"));
            if ("have-remote-offer" !== n.signalingState && "have-local-pranswer" !== n.signalingState) return Promise.reject(ue("InvalidStateError", "Can not call createAnswer in signalingState " + n.signalingState));
            ...
            return e && void 0 === e.sdpMLineIndex && !e.sdpMid ? Promise.reject(new TypeError("sdpMLineIndex or sdpMid required")) : new Promise(function(r, i) {
                if (!n._remoteDescription) return i(ue("InvalidStateError", "Can not add ICE candidate without a remote description"));
                if (e && "" !== e.candidate) {
                    ...
                    if (!s) return i(ue("OperationError", "Can not add ICE candidate"));
                    ...
                    if ((0 === o || o > 0 && s.iceTransport !== n.transceivers[0].iceTransport) && !le(s.iceTransport, c)) return i(ue("OperationError", "Can not add ICE candidate"));
            ...
            if (t && t instanceof e.MediaStreamTrack) {
                ...
                if (this.transceivers.forEach(function(e) {
                    ...
                    }), !n) throw ue("InvalidAccessError", "Invalid selector.");
                return n.getStats()
            }
            var r = [];
        ...
        ht = function() {
            ...
            return e.prototype.disable = function() {
                ...
                this._enabled && dt(function() {
                    ut.console.log(pt + "[Log]: " + e.join(" "))
                })
            }, e.prototype.warn = function() {
                for (var e = [], t = 0; t < arguments.length; t++) e[t] = arguments[t];
                this._enabled && dt(function() {
                    ut.console.warn(pt + "[Warn]: " + e.join(" "))
                })
            }, e.prototype.error = function() {
                for (var e = [], t = 0; t < arguments.length; t++) e[t] = arguments[t];
                this._enabled && dt(function() {
                    ut.console.error(pt + "[Error]: " + e.join(" "))
                })
            }, e
        }();
    ut.__SENTRY__ = ut.__SENTRY__ || {};
    var ft = ut.__SENTRY__.logger || (ut.__SENTRY__.logger = new ht),
        vt = function() {
            function e() {
        ...
        Ht = function() {
            ...
            return e.prototype.toString = function(e) {
                ...
                var n = ze(t.slice(1), 6),
                    ...
                    u = n[5],
                    p = u.split("/");
                p.length > 1 && (l = p.slice(0, -1).join("/"), u = p.pop()), Object.assign(this, {
                    host: s,
                    pass: a,
                    path: l,
                    projectId: u,
    ...
    var Kt, Yt = function() {
            ...
            return e.prototype.captureException = function(e, t, n) {
                ...
                var u = d.request;
                u && u.url && (u.url = Rt(u.url, c)), void 0 === d.event_id && (d.event_id = at()), this._addIntegrations(d.sdk);
                var p = Ot.resolve(d);
                return t && (p = t.applyToEvent(d, n)), p
    ...
    an._report = function() {
        ...
        function e(e) {
            ...
            for (var t, n, r, i = /^\s*at (?:(.*?) ?\()?((?:file|https?|blob|chrome-extension|native|eval|webpack|<anonymous>|[-a-z]+:|\/).*?)(?::(\d+))?(?::(\d+))?\)?\s*$/i, o = /^\s*(.*?)(?:\((.*?)\))?(?:^|@)?((?:file|https?|blob|chrome|webpack|resource|moz-extension).*?:\/.*?|\[native code\]|[^@]*(?:bundle|\d+\.js))(?::(\d+))?(?::(\d+))?\s*$/i, a = /^\s*at (?:((?:\[object object\])?.+) )?\(?((?:file|ms-appx|https?|webpack|blob):.*?):(\d+)(?::(\d+))?\)?\s*$/i, s = /(\S+) line (\d+)(?: > eval line \d+)* > eval/i, c = /\((\S*)(?::(\d+))(?::(\d+))\)/, d = e.stack.split("\n"), l = [], u = /^(.*) is undefined$/.exec(e.message), p = 0, h = d.length; p < h; ++p) {
                if (n = i.exec(d[p])) {
                    ...
                    if (!(n = o.exec(d[p]))) continue;
                    n[3] && n[3].indexOf(" > eval") > -1 && (t = s.exec(n[3])) ? (n[1] = n[1] || "eval", n[3] = t[1], n[4] = t[2], n[5] = "") : 0 !== p || n[5] || void 0 === e.columnNumber || (l[0].column = e.columnNumber + 1), r = {
                        url: n[3],
                        func: n[1] || sn,
                        args: n[2] ? n[2].split(",") : [],
                        line: n[4] ? +n[4] : null,
            ...
            return l.length ? (l[0] && l[0].line && !l[0].column && u && (l[0].column = null), {
                mode: "stack",
                name: e.name,
                message: e.message,
                stack: l
        ...
        function n(e, r) {
            ...
            return t(u, e.sourceURL || e.fileName, e.line || e.lineNumber, e.message || e.description), u
        }
                ...
                if (o = function(e) {
                        ...
                        for (var l = 2; l < t.length; l += 2) {
                            ...
                            (n = r.exec(t[l])) ? u = {
                                ...
                                line: n[1],
                                column: null
                            }), u && (u.func || (u.func = sn), u.context = [t[l + 1]], a.push(u))
                        }
                        return a.length ? {
                            mode: "multiline",
                            name: e.name,
    ...
    var un = an._report._subscribe,
        pn = an._report._installGlobalHandler,
    ...
    var jn = function() {
            ...
            return e.prototype.setupOnce = function() {
                Error.stackTraceLimit = 50, un(function(t, n, r) {
                ...
                }), this._options.onerror && (ft.log("Global Handler attached: onerror"), pn()), this._options.onunhandledrejection && (ft.log("Global Handler attached: onunhandledrejection"), hn())
    ...
    return class {
        constructor({
            ...
            if (this.version = "2.5.11", this.context = new h, this.context.startTime = new Date, this.context.sentry = e.sentry && (e.sentry.dsn || e.sentry.hasOwnProperty("logSending")) ? {
                    ...p.sentry,
                    ...e.sentry
                } : p.sentry, this.context.sdkVersion = this.version, this.context.logServer = e.logServer && (e.logServer.url || e.logServer.hasOwnProperty("logSending")) ? {
                    ...p.logServer,
                    ...e.logServer
                } : p.logServer, this.context.eventManager = function() {
                ...
                }), this.config = c(p, e), this.config.view.localStream = e.view.localStream || void 0, this.context.config = this.config, this.context.sdpSemantics = this.config.rtc && this.config.rtc.sdpSemantics ? this.config.rtc.sdpSemantics : p.rtc.sdpSemantics, this.context.simulcast = this.config.rtc && this.config.rtc.simulcast ? this.config.rtc.simulcast : p.rtc.simulcast, this.context.logLevel = this.config.dev && this.config.dev.logLevel ? this.config.dev.logLevel : "INFO", v.MediaDeviceCheck(this.context, this.config), this.media = new g(this.context), this.context.mediaManager = this.media, this.uri = p.appServer.url, this.key = this.config.credential.key, this.serviceId = this.config.credential.serviceId, this.context.key = this.key, this.context.serviceId = this.serviceId, this.context.state = "INIT", f.init(this.context), this.config.rtc.selectiveCandidate && this.config.rtc.selectiveCandidate.serverUrls && (this.config.rtc.iceServers = c([], this.config.rtc.selectiveCandidate.serverUrls)), this.config.media || (this.config.media = {
                    audio: !0,
                    video: !0,
                    record: !1
        ...
        async joinCast(e) {
            f.d("joinCast is called"), this.config.rtc.audioType = "music", this.context.channel.type = "VIEWER", this.context.channel.id = e, this.config.media.recvonly = !0, await this.init(), f.qualityLog({
                type: "quality.start",
                config: this.context.config
            }), "Safari" !== u.name && "safari" !== u.name || await navigator.mediaDevices.getUserMedia({
                audio: !0
        ...
        async captureScreen(e = 640, t = 480, n = 30, r = !0) {
            this.media.captureScreen(e, t, n, r)
        }
        stopCaptureScreen() {
